...
<head>
    ...
    <link rel="stylesheet" href="csslogin/styleCadastroNovoUsuario.css">
    ...
    <section>
        <div class="form-box">
            <div class="form-value">
                <form method="POST" action="php/salva-usuario.php?opcao=I&id=0" enctype="multipart/form-data" id="formCadastro" onsubmit="return validarCadastro()">
                    <h2>Criar Conta</h2>
                    <div class="inputbox">
